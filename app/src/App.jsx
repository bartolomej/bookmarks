  ...
  return (
    <Container>
      ...
      <Body>
        ...
        <Section>
          {matchedTreeData.length > 0 && (
            <SectionTitle css={`text-align: center`} id="index">Jump to ...</SectionTitle>
          )}
          <Index tree={matchedTreeData} metadata={metaData}/>
        </Section>
        {matchedTreeData.map(renderSection)}
      </Body>
      {matchedTreeData.length > 0 && (
        <GoToTopButton href="#index">
          <GoToTopSvg/>
        </GoToTopButton>
      )}
    </Container>
    ...
    if (!section.subsections) {
      return (
        <Section key={section.name}>
          <SectionTitle id={section.name}>{section.title}</SectionTitle>
          <LinksContainer>
      ...
      <Section key={section.name}>
        ...
        <LinksContainer>
          {section.subsections.map(s => {
            return (
              <Subsection>
                <SubsectionTitle id={s.name}>{s.title}</SubsectionTitle>
                <LinksContainer>
...
const GoToTopSvg = styled(ArrowAsset)`
  height: 30px;
