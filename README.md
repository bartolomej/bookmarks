...
- [A React Native starter app](https://github.com/alexwasner/react-native-mobx-firebase-starter) - with Wix React Native Navigation V2, MobX and Firebase
...
- [Nodemailer](https://nodemailer.com/about/) - send mails with nodejs
- [Powerful design and animation tool](https://www.2dimensions.com/about-flare)
- [FontFlipper](https://fontflipper.com/upload) - Choose suitable fonts
- [ProjectVisBug](https://github.com/GoogleChromeLabs/ProjectVisBug) - Website visual debugging tool
- [CloudCraft](https://cloudcraft.co/) - Visualize your cloud architecture
- [Figma](https://www.figma.com/) - design and prototyping tool
- [BundlePhobia](https://bundlephobia.com/) - Find the cost of adding a npm package to your bundle
- [Baloon.css](https://kazzkiq.github.io/balloon.css/) - Simple tooltips made with css
- [Createjs](https://www.createjs.com/) - Web content creation library
...
- [Tutorial website on writing a parser](http://lisperator.net/pltut/parser/)
...
- [Best math channel on yt](https://www.3blue1brown.com/)
...
- [Integrative complexity](https://en.wikipedia.org/wiki/Integrative_complexity)
- [Fluid and crystallised intelligence](https://en.wikipedia.org/wiki/Fluid_and_crystallized_intelligence)
...
- [Open source license guide](https://opensource.guide/legal/)
...
- [Miro](https://miro.com/) - collaboration software
- [Gitcoin](https://gitcoin.co/) - powering crowdfunding
- [Foam](https://foam.space/) - Distributed location network
- [Anigma](https://enigma.co/) - Distributed private computational network
- [Elastos](https://www.elastos.org/) - Distributed ecosystem
...
- [Anze Vodovnik](https://www.vodovnik.com/)
- [Atlassian](https://www.atlassian.com/blog)
- [Scotch](https://scotch.io/) - Fun and practical web development tutorials and blogs
- [Tweeter engineering](https://blog.twitter.com/engineering/en_us.html)
- [Martin Fower microservices](https://martinfowler.com/articles/microservices.html)
- [Rising Stack](https://blog.risingstack.com/)
- [Joel on Software](https://www.joelonsoftware.com/)
- [Gear.dev](https://gear.dev/blog/) - A software engineer with a passion for distributed systems, machine learning and brain-computer interfaces
- [Blog from ethereum developer](http://frozeman.de/blog/)
- [Statechain](https://statecharts.github.io/)
- [Microsoft Azure](https://docs.microsoft.com/en-us/azure/devops/learn/)
...
- [The Misbehavior of Markets](https://www.goodreads.com/book/show/665134.The_Mis_Behavior_of_Markets)
- [Chaos: The Making of a New Science](https://www.goodreads.com/book/show/64582.Chaos)
- [How Nature Works: the science of self-organized criticality](https://www.goodreads.com/book/show/869836.How_Nature_Works)
